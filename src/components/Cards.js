...
function Cards(props) {
  ...
  return (
    <div className='card mt-10 flex flex-col items-center md:flex-row md:max-w-xl'>
      <img className="object-cover w-full rounded-t-lg h-96 md:h-auto md:w-48 md:rounded-none md:rounded-l-lg" src={`../src/images/${props.data.image}`} alt = "location images" />
      <div>
